...
#' The original function (SpatialDeltaGLMM::Geostat_Sim) is available in 
...
#' @export
#' 
get_sim <- function(Sim_Settings, Extrapolation_List, Data_Geostat=NULL, MakePlot=FALSE, DateFile=paste0(getwd(),"/"), standardize_fields=FALSE ){
  # Terminology
